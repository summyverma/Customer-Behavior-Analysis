...
# 3.Which are rhe top 5 porodcts with the highest average review rating?
...
#4.compare the average puchase amounts between standard an experess shipping
...
#5. do subsccribed customers spend more? Compare average spend and total revenue between subscribers and non-subscribers.
...
# Segment customers into New, Returning and Loyal based on their total number of previous pruchases, 
